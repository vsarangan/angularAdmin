...
import { Component, OnInit, ViewChild, Renderer, Renderer2, ElementRef, HostListener, Input, Output, EventEmitter } from '@angular/core';
...
export class AdvancedSearchComponent implements OnInit {
 ...
 //  this.parametersTemp = this.controlVisibility(searchParam);
  ...
  IsReachedArray() {
    return this.searchParams.length === 10 ? false : true;
  }
  ...
  formSubmit(formdata) {
    ...
    this.resultSearch.emit(this.finalResult);
  }
