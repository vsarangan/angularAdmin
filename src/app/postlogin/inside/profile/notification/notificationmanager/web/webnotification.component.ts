...
@Component({
  ...
  styleUrls: ['./webnotification.component.css'],
  providers: []
})
export class WebNotificationComponent {
  ...
  columns = [{ detail: 'ID', data: 'id' }, { detail: 'Name', data: 'name' }, { detail: 'Header', data: 'header' }, { detail: 'Message', data: 'message' }, { detail: 'Common', data: 'common' }];
